...
public class Main {
     ...
     * we choose i value in the iStr.skip(i) that we want to skip
     */
    private static void demo1() {
        ...
        iStr.skip(6).forEach(System.out::println);
    }
    ...
    private static void demo2() {
        ...
        System.out.println("LIST1: " + LIST1);
        /**
         * Here we have a list.Peek1 check return the number, Peek2 check if n%2=0 and Peek3 return n>5
         * 1 pass only peek1 for example
         *
         */
