...
public class Main {
    ...
    public static void main(String[] args) {
       demo1();
        ...
        demo4();
        demo5();
        System.out.println("test first function \n");
        ex01("Frank Darabont");
        System.out.println("test second function\n");
        ex02("Ralph Fiennes");
    }
}
